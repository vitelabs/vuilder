...
function startLocalNetwork(node = 'nightly') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nodeConfig = config.cfg().nodes[node];
        yield (0, node_1.init)({ name: nodeConfig.name, version: nodeConfig.version });
        console.log('Node binanry:', nodeConfig.name);
        (0, child_process_1.exec)(`./restart.sh ${nodeConfig.name}`, {
            cwd: binPath
        }, (error, stdout, stderr) => {
