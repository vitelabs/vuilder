...
exports.binPath = exports.binName = exports.init = void 0;
const child_process_1 = require("child_process");
const package_json_1 = require("../package.json");
const fs_1 = __importDefault(require("fs"));
const defaultBinPath = `node_modules/${package_json_1.name}/bin/`;
// const binPath = `bin/`;
function init({ name = "gvite", version, type = "bin", }) {
    return __awaiter(this, void 0, void 0, function* () {
        let binFileName = yield binName(name, version);
        if (fs_1.default.existsSync(binPath() + binFileName)) {
            return;
        }
        ...
        const result = (0, child_process_1.execSync)(`${shell}  ${version} ${platform}`, {
            cwd: binPath(),
            encoding: "utf8",
        });
        console.log(result);
