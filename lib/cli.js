...
function parseConfig(argv) {
    if (argv.config) {
        ...
        return options(argv, Object.assign({}, config_default_json_1.default, configJson));
    }
    else {
        return options(argv, config_default_json_1.default);
    }
}
...
function runTest(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield vuilder.stopLocalNetworks();
...
require("yargs/yargs")(process.argv.slice(2))
    ...
    const viteCfg = parseConfig(argv);
    yield vuilder.startLocalNetwork(viteCfg);
}))
