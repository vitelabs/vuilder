...
class Contract {
    ...
    call(methodName, params, { tokenId = Vite_TokenId, amount = "0", caller = this.deployer, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const block = caller === null || caller === void 0 ? void 0 : caller.callContract({
            ...
            if ((receiveBlock.blockType !== 4 && receiveBlock.blockType !== 5) ||
                !receiveBlock.data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                let result = codeBase64
                    ? yield ((_a = this.provider) === null || _a === void 0 ? void 0 : _a.request("contract_callOffChainMethod", {
                        address: this.address,
                        code: codeBase64,
                        data: dataBase64,
                    }))
                    : yield ((_b = this.provider) === null || _b === void 0 ? void 0 : _b.request("contract_query", {
                        address: this.address,
                        data: dataBase64,
                    }));
                // parse result
    ...
    getPastEvents(eventName = "allEvents", { fromHeight = 0, toHeight = 0, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            let logs = yield ((_a = this.provider) === null || _a === void 0 ? void 0 : _a.request("ledger_getVmLogsByFilter", {
                addressHeightRange: {
                    [this.address]: {
            ...
            // console.log(logs);
            const filteredAbi = eventName === "allEvents"
                ? this.abi
                : this.abi.filter((a) => {
    ...
    balance(tokenId = "tti_5649544520544f4b454e6e40") {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.address) {
                const result = yield ((_a = this.provider) === null || _a === void 0 ? void 0 : _a.getBalanceInfo(this.address));
                const balanceInfo = result === null || result === void 0 ? void 0 : result.balance;
                return ((_b = balanceInfo.balanceInfoMap) === null || _b === void 0 ? void 0 : _b[tokenId].balance) || "0";
            }
            else {
