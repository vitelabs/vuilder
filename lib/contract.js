...
class Contract {
    ...
    query(methodName, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = vitejs_1.abi.encodeFunctionCall(methodAbi, params);
    ...
    getPastEvents(eventName = 'allEvents', { fromHeight = 0, toHeight = 0 }) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = [];
            const logs = yield this.provider.request("ledger_getVmLogsByFilter", {
                "addressHeightRange": {
                    [this.address]: {
            ...
            if (logs) {
                for (const log of logs) {
                    ...
                    for (const abiItem of filteredAbi) {
                        const signature = vitejs_1.abi.encodeLogSignature(abiItem);
                        ...
                        if (abiItem.type === 'event' && signature === topics[0]) {
                            ...
                            const returnValues = vitejs_1.abi.decodeLog(abiItem, dataHex, topics);
                            const item = {
