...
class UserAccount extends vitejs_1.accountBlock.Account {
    // _provider: any;
    ...
    receiveAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const blocks = yield this.provider.request("ledger_getUnreceivedBlocksByAddress", this.address, 0, 100);
            if (blocks) {
